...
export default function WikiPage() {
  ...
  if (!config.tenantId) return <main className="min-h-screen bg-slate-50 p-8"><div className="mx-auto max-w-xl rounded-xl border bg-white p-8 text-center"><Building2 className="mx-auto h-8 w-8 text-blue-600" /><h1 className="mt-3 text-2xl font-bold">Create your Wiki workspace</h1><p className="mt-2 text-slate-600">You do not have a personal Wiki tenant yet. Create one only when you are ready to store and share knowledge. Tenants you join by invitation will also appear here with their role.</p><WikiTenantControls emptyState /></div></main>;
