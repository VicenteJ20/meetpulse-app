...
export function LanguageSelection({
  ...
  const availableLanguages = isParakeet
    ...
    : LANGUAGES.filter(lang => ['auto', 'es', 'en'].includes(lang.code));
    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        <select
          ...
          className="w-full px-3 py-2 text-sm bg-card border border-border rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 disabled:bg-muted/50 disabled:text-muted-foreground"
        >
        ...
        {isParakeet && (
          <div className="p-2 bg-warning/10 border border-warning/25 rounded text-warning">
        ...
        <div className="text-xs space-y-2 pt-2">
          ...
          {selectedLanguage === 'auto-translate' && (
            <div className="p-2 bg-brand/10 border border-brand/25 rounded text-brand">
