  ...
  return (
    <>
      <div className="space-y-4">
        ...
        <div className="flex items-start gap-2 p-2 bg-brand/10 rounded border border-brand/25">
          ...
          <div className="text-xs text-brand">
            ...
            <button
              ...
              className="text-blue-600 hover:text-brand underline hover:no-underline"
            >
              View Privacy Policy
            </button>
          </div>
