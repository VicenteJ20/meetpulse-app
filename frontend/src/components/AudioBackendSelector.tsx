...
export function AudioBackendSelector({
  ...
  return (
    <div className="space-y-2">
      ...
      {error && (
        <div className="p-2 text-xs text-destructive bg-destructive/10 border border-destructive/25 rounded-md">
          {error}
        </div>
      )}
            ...
            >
              ...
              <div className="ml-3 flex-1">
                <div className="flex items-center justify-between">
                  ...
                  {currentBackend === backend.id && (
                    <span className="text-xs font-medium text-blue-600 bg-brand/15 px-2 py-0.5 rounded">
                      Active
                    </span>
                  )}
                  {isCoreAudio && (
