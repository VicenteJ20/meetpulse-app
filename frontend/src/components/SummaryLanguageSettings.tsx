          ...
          return (
            ...
            >
              ...
              >
                <Pin
                  size={14}
                  className={isPinned ? 'text-blue-600' : 'text-muted-foreground'}
              ...
              <button
                ...
                className={`pr-2.5 pl-0.5 py-1 leading-none ${isPinned ? 'text-blue-400 hover:text-brand' : 'text-muted-foreground hover:text-foreground'}`}
              >
                ×
              </button>
            </span>
