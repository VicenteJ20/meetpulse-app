                ...
                {isStreaming ? (
                  ...
                  <div className="rounded-lg border border-border bg-muted/70 px-3 py-2">
                    <div className="relative">
                      <p className="text-base leading-relaxed text-foreground" style={{ visibility: 'hidden' }}>
                        {sizerText}
                      </p>
                      <p className="absolute left-0 top-0 text-base leading-relaxed text-foreground">
                        {displayText}
                      </p>
                    </div>
                  </div>
      ...
      {transcripts.length === 0 && (
        ...
        >
          {isRecording ? (
            ...
            <>
              <p className="text-lg font-semibold">Welcome to MeetPulse!</p>
